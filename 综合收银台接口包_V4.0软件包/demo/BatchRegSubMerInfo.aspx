...
<script runat="server">
    ...
    protected void btnButton_Click(object sender, EventArgs e)
    {
        ...
        //1、生成商户交易查询请求对象
        com.abc.trustpay.client.ebus.BatchRegSubMerInfo tRequest = new com.abc.trustpay.client.ebus.BatchRegSubMerInfo();   //设定交易类型（必要信息）
    ...
    <form id="form1" runat="server">
        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox runat="server" ID='flag' Text='1' /> *必输(取值1、2和3) </td>
