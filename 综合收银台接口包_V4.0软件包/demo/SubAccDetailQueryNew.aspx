...
<script runat="server">
    ...
    protected void btnButton_Click(object sender, EventArgs e)
    {
        ...
        //1、生成二级商户明细查询请求对象
        com.abc.trustpay.client.ebus.SubMerAccDetailQryNewRequest tRequest = new com.abc.trustpay.client.ebus.SubMerAccDetailQryNewRequest();
        tRequest.dicRequest["SubMerchantNo"] = txtSubMerchantNo.Text;   //二级商户号 （必要信息）
        tRequest.dicRequest["AccDate"] = txtStartDate.Text;   //会计日期 （必要信息）
    ...
    <form id="form1" runat="server">
        ...
        <table>
            ...
            <tr>
                <td>翻页查询标识</td>
                <td>
                    <asp:TextBox runat="server" ID='txtNumEntryRec' Text='' />首次送空，续查送1</td>
            </tr>
            <tr>
                <td>日志号</td>
                <td>
