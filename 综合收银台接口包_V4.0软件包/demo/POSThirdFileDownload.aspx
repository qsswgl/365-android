...
<script runat="server">
    ...
    protected void btnButton_Click(object sender, EventArgs e)
    {
        ...
        //1、生成查询请求对象
        com.abc.trustpay.client.ebus.POSThirdFileDownload tRequest = new com.abc.trustpay.client.ebus.POSThirdFileDownload();
        tRequest.queryRequest["SubMerchantNo"] = SubMerchantNo.Text;   //二级商户号
    ...
    <form id="form1" runat="server">
        ...
        <table>
            <tr>
                <td>二级商户号</td>
                <td>
                    <asp:TextBox runat="server" ID='SubMerchantNo' Text='' Width="228px" />*必输</td>
            </tr>
              <tr>
                <td>清算日期</td>
                <td>
