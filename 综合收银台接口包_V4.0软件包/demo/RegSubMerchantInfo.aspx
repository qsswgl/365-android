...
<script runat="server">
    ...
    protected void btnButton_Click(object sender, EventArgs e)
    {
        ...
        //}
         //1、生成支付请求对象
        com.abc.trustpay.client.ebus.RegSubMerchantInfoRequest tMerchantInfo = new com.abc.trustpay.client.ebus.RegSubMerchantInfoRequest();
...
<body style="font-size: 14px;">
    ...
    <form id="form1" runat="server">
        ...
        <table>
            ...
            <tr>
                <td>二级商户类型</td>
                <td><asp:TextBox runat="server" ID='txtSubMerType' value='1' />*必输 1个人商户 2企业商户</td>
            </tr>      
                        <tr>
                <td>二级商户状态</td>
                <td><asp:TextBox runat="server" ID='txtStatus' value='1' />*必输 0:关闭 1:正常</td>
            </tr>          
                        <tr>
                <td>法定代表人或负责人名称</td>
            ...
            <tr>
                ...
                <td><asp:TextBox runat="server" ID='txtReceiveAccountName' value='张三' />*必输</td>
                        ...
                        <tr>
                <td>收款账号</td>
                <td><asp:TextBox runat="server" ID='txtReceiveAccount' value='6228888888888888888' />*必输</td>
            </tr> 
            <tr>
                <td>收款银行</td>
