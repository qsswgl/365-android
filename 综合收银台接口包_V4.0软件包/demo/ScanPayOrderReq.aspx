...
<script runat="server">
    ...
    protected void btnButton_Click(object sender, EventArgs e)
    {
        ...
        com.abc.trustpay.client.ebus.ScanPayOrderReq tPaymentRequest = new com.abc.trustpay.client.ebus.ScanPayOrderReq();
        //2、设定订单属性
        ...
        string ScanPayQRURL = JSON.GetKeyValue("ScanPayQRURL");
        if (ReturnCode.Equals("0000"))
        {
            strMessage.Append("ReturnCode   = [" + ReturnCode + "]<br/>");
            strMessage.Append("ErrorMessage = [" + ErrorMessage + "]<br/>"); 
            strMessage.Append("ScanPayQRURL = [" + ScanPayQRURL + "]<br/>"); 
...
<head>
    <title>农行网上支付平台-商户接口范例-一码多扫下单</title>
</head>
