...
<script runat="server">
    ...
    protected void btnButton_Click(object sender, EventArgs e)
    {
        ...
        //1、生成对账单查询请求对象
        com.abc.trustpay.client.ebus.SettleRequestAliWXDZH tRequest = new com.abc.trustpay.client.ebus.SettleRequestAliWXDZH();
...
<head>
    <title>农行网上支付平台-商户接口范例-垫资户模式微信支付宝对账单下载</title>
</head>
<body style="font-size: 14px;">
    <center>
        垫资户模式微信支付宝对账单下载</center>
