...
<script runat="server">
    ...
    protected void btnButton_Click(object sender, EventArgs e)
    {
        ...
        //1、生成商户交易查询请求对象
        com.abc.trustpay.client.ebus.BatchUpdateSubMerInfo tRequest = new com.abc.trustpay.client.ebus.BatchUpdateSubMerInfo();   //设定交易类型（必要信息）
        
        //string name = fileName.Text;    //设定交易类型（必要信息）
        //string filestring = tRequest.ZipFileToBase64String(name);
        tRequest.dicRequest["SubMerInfoFile"] = BatchSubMerInfoFile.Text;
        ...
        string ErrorList = JSON.GetKeyValue("ErrorList");
        if (ReturnCode.Equals("0000"))
        {
            ...
            strMessage.Append("ErrorList   = [" + ErrorList + "]<br/>");                   //二级商户余额
    ...
    <script>
        ...
        function uploadfile() {
            ...
            reads.onload = function (e) {
                ...
                document.getElementsByName('BatchSubMerInfoFile')[0].value = e.target.result.substring(e.target.result.indexOf(',') + 1)
            };
    ...
    <form id="form1" runat="server">
        ...
        <table>
            ...
            <tr>
                ...
                <td>
                      <input type="file" id="file" accept=".txt" onchange="uploadfile();" />
                   <%-- <asp:TextBox runat="server" ID='fileName' Text='D:\bigzip.zip' /> --%>*必输，txt文件</td>
            </tr>
            <tr>
                <td>标志位
                </td>
                <td>
                    <asp:TextBox runat="server" ID='flag' Text='1' />无需输入</td>
                <td><asp:TextBox runat="server" ID='BatchSubMerInfoFile' value='' style="display:none"/></td>
            </tr>
            <tr>
                <td colspan="2">
                    <tr>
