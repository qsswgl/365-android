...
<script runat="server">
    ...
    protected void btnButton_Click(object sender, EventArgs e)
    {
        ...
        //1、生成支付请求对象
        com.abc.trustpay.client.ebus.QrySubCustomReviewStatus tMerchantInfo = new com.abc.trustpay.client.ebus.QrySubCustomReviewStatus();
...
<head>
    <title>农行网上支付平台-商户接口范例-客户申请状态查询</title>
</head>
    ...
    <form id="form1" runat="server">
        ...
        <table>
            ...
            <tr>
                <td>申请单号</td>
                <td>
                    <asp:TextBox runat="server" ID='txtSerialNo' value='18ECEP01085931969003' />*必输</td>
            </tr>
            <tr>
                <td colspan="2">
