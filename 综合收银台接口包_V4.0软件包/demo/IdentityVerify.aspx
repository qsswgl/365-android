...
<script runat="server">
    ...
    {
        //1、生成身份验证请求对象
        com.abc.trustpay.client.ebus.IdentityVerifyRequest tRequest = new com.abc.trustpay.client.ebus.IdentityVerifyRequest();
        tRequest.dicRequest["CustomType"] = txtCustomType.Text; //客户类型 （必要信息）
        tRequest.dicRequest["BankCardNo"] = txtBankCardNo.Text;                    //银行帐号       （必要信息）
        ...
        tRequest.dicRequest["ResultNotifyURL"] = txtResultNotifyURL.Text;          //身份验证回传网址（必要信息）
        tRequest.dicRequest["OrderDate"] = txtOrderDate.Text;              //验证请求日期 （必要信息 - YYYY/MM/DD）
        tRequest.dicRequest["OrderTime"] = txtOrderTime.Text;              //验证请求时间 （必要信息 - HH:MM:SS）
        tRequest.dicRequest["PaymentLinkType"] = txtPaymentLinkType.Text; //交易渠道 （必要信息 - HH:MM:SS）
        ...
        if (ReturnCode.Equals("0000"))
        {
            ...
            Response.Redirect(JSON.GetKeyValue("VerifyURL"));
        }
        else
        {
    ...
    <form id="form1" runat="server">
        ...
        <table>
            <tr>
                ...
                <td>
                    <asp:TextBox runat="server" ID='txtCustomType' Text='1' />个人0，对公1，*必输</td>
            </tr>
            <tr>
                <td>请求日期</td>
                <td>
                    <asp:TextBox runat="server" ID='txtOrderDate' Text='2008/01/17' />
                    *必输，格式要求为YYYY/MM/DD</td>
            </tr>
            <tr>
                <td>请求时间</td>
                <td>
