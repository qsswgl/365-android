...
<script runat="server">
    ...
    {
        //1、生成请求对象
        com.abc.trustpay.client.ebus.SubEWalletPayForOutterV2Request tRequest = new com.abc.trustpay.client.ebus.SubEWalletPayForOutterV2Request();
        //2、生成定单订单对象
...
<head>
    <title>农行网上支付平台-商户接口范例-子钱包支付交易V2</title>
</head>
    ...
    <form id="form1" runat="server">
        ...
        <table>
            <tr>
                ...
                <td>
                    <asp:TextBox runat="server" ID='txtOrderNo' Text='Test20220314001' />*必输</td>
            </tr>
            <tr>
                <td>Token
                </td>
                <td>
                    <asp:TextBox runat="server" ID='txtToken' Text='000003202112284766875181287' />*必输</td>
            </tr>
            <tr>
                <td>交易金额
                </td>
