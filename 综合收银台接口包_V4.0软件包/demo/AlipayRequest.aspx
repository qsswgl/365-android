...
<script runat="server">
    ...
    protected void btnButton_Click(object sender, EventArgs e)
    {
        ...
        com.abc.trustpay.client.ebus.AlipayRequest tPaymentRequest = new com.abc.trustpay.client.ebus.AlipayRequest();
        //2、设定订单属性
        ...
        tPaymentRequest.dicOrder["PAYED_RETURN_URL"] = txtPayedReturnUrl.Text;//设定支付后回调地址
        ...
        tPaymentRequest.dicOrder["WAP_QUIT_URL"] = txtWapQuitUrl.Text; //支付宝WAP中途退出URL
        tPaymentRequest.dicOrder["PC_QR_PAY_MODE"] = txtPcQrPayMode.Text; //支付宝WAP中途退出URL
        tPaymentRequest.dicOrder["PC_QRCODE_WIDTH"] = txtPcQrCodeWidth.Text; //支付宝WAP中途退出URL
        tPaymentRequest.dicOrder["TIMEOUT_EXPRESS"] = txtTimeoutExpress.Text; //支付宝WAP中途退出URL
        tPaymentRequest.dicOrder["ChildMerchantNo"] = ChildMerchantNo.Text; //子商户(大商户模式)
        ...
        if (ReturnCode.Equals("0000"))
        {
            ...
            if (!QRURL.Equals(""))
            {
                ...
                strMessage.AppendLine();
                strMessage.Append("ThirdReOrderNo       = [" + JSON.GetKeyValue("ThirdReOrderNo") + "]<br/>");
            ...
            else
            {
                ...
                strMessage.Append("ErrorMessage = [" + ErrorMessage + "]<br/>");
                strMessage.AppendLine();
                strMessage.Append("PrePayID     = [" + Encoding.GetEncoding("gb2312").GetString(Convert.FromBase64String(JSON.GetKeyValue("PrePayID"))) + "]<br/>");
                strMessage.AppendLine();
                //strMessage.Append("TRADE_NO = [" + JSON.GetKeyValue("TRADE_NO") + "]<br/>");
                strMessage.Append("ThirdOrderNo       = [" + JSON.GetKeyValue("ThirdOrderNo") + "]<br/>");
                strMessage.AppendLine();
                strMessage.Append("ThirdReOrderNo       = [" + JSON.GetKeyValue("ThirdReOrderNo") + "]<br/>");
        ...
        lblMessage.Attributes.Add("style", "overflow-y:hidden");
...
<body style="font-size: 14px;">
    ...
    <form id="form1" runat="server">
        ...
        <asp:TextBox TextMode="MultiLine" ID="lblMessage" runat="server" Text="" Width="50%" Rows="20" Visible="false" Wrap="true"></asp:TextBox>
        <br />
        <table>
            <tr>
                <td>交易类型</td>
                <td style="width: 258px">
                    <asp:DropDownList ID="txtPayTypeID" runat="server" onclick="SelectedIndexChanged()">
                        <asp:ListItem Value="ALI_PC" Selected="True">PC网站支付</asp:ListItem>
                        <asp:ListItem Value="ALI_WAP">WAP支付</asp:ListItem>
                        <asp:ListItem Value="ALI_APP">APP支付</asp:ListItem>
                        <asp:ListItem Value="ALI_PRECREATE">线下主扫支付宝</asp:ListItem>
                        <asp:ListItem Value="ALI_CREATE">线下静态一码多付</asp:ListItem>
                        <asp:ListItem Value="ALI_PAY">刷卡支付</asp:ListItem>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox runat="server" ID='txtAccountNo' Text='' />选输,交易类型为“线下静态一码多付”时必输，输入客户的支付宝userid；
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox runat="server" ID='txtPaymentType' Text='9' onkeyup="CheckValue()" />9：支付宝支付 ，*必输</td>
            </tr>
            <tr>
                <td>交易渠道
                </td>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox runat="server" ID='txtPayedReturnUrl' Text='your payed return url' />支付宝回调支付结果时填写</td>
            </tr>
            <tr>
                <td>附言
                </td>
            ...
            <tr>
                <td>WAP支付中途退出返回网址</td>
                <td>
                    <asp:TextBox runat="server" ID='txtWapQuitUrl' Text='' />选输</td>
            </tr>
                        <tr>
                <td>二级商户编号（大商户模式）</td>
                <td>
                    <asp:TextBox runat="server" ID='ChildMerchantNo' Text='' />选输</td>
            </tr>
            <tr>
                <td>PC扫码支付方式</td>
                <td>
                    <asp:TextBox runat="server" ID='txtPcQrPayMode' Text='' />PC网站支付时必输</td>
            </tr>
             <tr>
                <td>自定义二维码宽度</td>
                <td>
                    <asp:TextBox runat="server" ID='txtPcQrCodeWidth' Text='' />PC扫码支付方式为4时必输</td>
            </tr>
            <tr>
                <td>支付宝订单有效期</td>
                <td>
                    <asp:TextBox runat="server" ID='txtTimeoutExpress' Text='1d' />取值范围1m-15d,不接收小数点</td>
            </tr>
            <tr>
                <td>限制贷记卡
                </td>
            ...
            <tr>
                <td colspan="2">
                    <asp:Button ID="btnButton" runat="server" Text="提交" OnClick="btnButton_Click" />
