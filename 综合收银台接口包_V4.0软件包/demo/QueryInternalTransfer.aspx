...
<script runat="server">
    ...
    protected void btnButton_Click(object sender, EventArgs e)
    {
        ...
        //1、生成支付请求对象
        com.abc.trustpay.client.ebus.QueryInternalTransfer tMerchantInfo = new com.abc.trustpay.client.ebus.QueryInternalTransfer();

        //3、设置请求值
        tMerchantInfo.merchantInfoRequest["TransferNo"] = txtTransferNo.Text;
...
<head>
    <title>农行网上支付平台-商户接口范例-内转交易查询</title>
</head>
    ...
    <form id="form1" runat="server">
        ...
        <table>
            <tr>
                <td>内转请求流水号</td>
                <td>
                    <asp:TextBox runat="server" ID='txtTransferNo' value='No123456789' />*必输</td>
            </tr>
            <tr>
                <td colspan="2">
