...
<script runat="server">
    ...
    protected void btnButton_Click(object sender, EventArgs e)
    {
        ...
        //1、生成代收批量扣款查询请求对象
        com.abc.trustpay.client.ebus.EntrustBatchPaymentQueryRequest tRequest = new com.abc.trustpay.client.ebus.EntrustBatchPaymentQueryRequest();
        ...
        if (ReturnCode.Equals("0000"))
        {
            ...
            if (dic.Count == 0)
            {
                strMessage.Append("代收批量扣款明细为空<br/>");
            }
            else
            {
...
<head>
    <title>农行网上支付平台-商户接口范例-代收批量扣款处理结果结果查询</title>
</head>
