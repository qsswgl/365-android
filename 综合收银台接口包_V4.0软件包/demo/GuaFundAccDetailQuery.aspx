...
<script runat="server">
    ...
    protected void btnButton_Click(object sender, EventArgs e)
    {
        ...
        //1、生成保证金账户明细查询请求对象
        com.abc.trustpay.client.ebus.GuaFundAccDetailQueryRequest tRequest = new com.abc.trustpay.client.ebus.GuaFundAccDetailQueryRequest();
        ...
        //2、传送保证金账户明细查询请求并取得二级商户明细
        tRequest.postJSONRequest();

        //3、判断保证金账户明细查询结果状态，进行后续操作
...
<head>
    <title>农行网上支付平台-商户接口范例-保证金账户明细查询</title>
</head>
