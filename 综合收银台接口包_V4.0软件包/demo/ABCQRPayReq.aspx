...
<script runat="server">
    ...
    protected void btnButton_Click(object sender, EventArgs e)
    {
        ...
        com.abc.trustpay.client.ebus.QRPayCode tPaymentRequest = new com.abc.trustpay.client.ebus.QRPayCode();
        //2、设定订单属性
        tPaymentRequest.dicOrder["QRPayCode"] = txtQRPayCode.Text;    //客户二维码
        tPaymentRequest.dicOrder["Pid"] = txtPid.Text;    //客户PID
        ...
        orderitem["SubMerName"] = "1";    //设定二级商户名称
        ...
        orderitem["ProductName"] = "1";//商品名称
        orderitem["UnitPrice"] = "1.00";//商品总价
        orderitem["Qty"] = "1";//商品数量
        orderitem["ProductRemarks"] = "2"; //商品备注项
        ...
        orderitem["SubMerName"] = "2";    //设定二级商户名称
        orderitem["SubMerId"] = "12345";    //设定二级商户代码
        orderitem["SubMerMCC"] = "0000";   //设定二级商户MCC码 
        orderitem["SubMerchantRemarks"] = "测试";   //二级商户备注项
        orderitem["ProductID"] = "IP000001";//商品代码，预留字段
        orderitem["ProductName"] = "2";//商品名称
        orderitem["UnitPrice"] = "1.00";//商品总价
        orderitem["Qty"] = "2";//商品数量
        orderitem["ProductRemarks"] = "1"; //商品备注项
        orderitem["ProductType"] = "充值类";//商品类型
        orderitem["ProductDiscount"] = "0.9";//商品折扣
        orderitem["ProductExpiredDate"] = "10";//商品有效期
        ...
        tPaymentRequest.dicRequest["TerminalNo"] = txtTerminalNo.Text;    //设定终端编号
    ...
    <form id="form1" runat="server">
        ...
        <table>
            <tr>
                ...
                <td>
                    <asp:TextBox runat="server" ID='txtQRPayCode' Text='1234567890' />*必输</td>
            </tr>
             <tr>
                <td>客户PID
                </td>
                <td>
                    <asp:TextBox runat="server" ID='txtPid' Text='1234567890' />*必输</td>
            </tr>
            <tr>
                <td>订单日期
                </td>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox runat="server" ID='txtTerminalNo' Text='1' /></td>
            </tr>
                        <tr>
                <td>附言
                </td>
