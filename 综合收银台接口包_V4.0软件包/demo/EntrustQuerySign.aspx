...
<script runat="server">
    ...
    protected void btnButton_Click(object sender, EventArgs e)
    {
        ...
        //1、生成支付请求对象
        com.abc.trustpay.client.ebus.EntrustQuerySign tMerchantInfo = new com.abc.trustpay.client.ebus.EntrustQuerySign();
        ...
        if (ReturnCode.Equals("0000"))
        {
            ...
            strMessage.Append("InvaidDate = [" + JSON.GetKeyValue("InvaidDate") + "]<br/>");
            ...
            strMessage.Append("SignChannel = [" + JSON.GetKeyValue("SignChannel") + "]<br/>");
        }
        else
        {
            //6、请求提交失败，商户自定后续动作
