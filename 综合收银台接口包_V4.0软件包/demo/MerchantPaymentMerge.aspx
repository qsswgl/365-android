...
<script runat="server">
    ...
    protected void btnButton_Click(object sender, EventArgs e)
    {
        ...
        com.abc.trustpay.client.ebus.MergePaymentRequest tPaymentRequest = new com.abc.trustpay.client.ebus.MergePaymentRequest();
        //2、设定订单属性
        ...
        orderitem["SubOrderNo"] = "Sub20170608001";    //设定二级商户名称
        orderitem["SubMerName"] = "测试二级商户1";    //设定二级商户名称
        orderitem["SubMerId"] = "103881104410001";    //设定二级商户代码
        ...
        orderitem["SubIsBreakAccount"] = "1";//是否分账
        orderitem["SubSplitAccTemplate"] = "0001";//分账模板       
        tPaymentRequest.dic.Add(1, orderitem);

        orderitem = new System.Collections.Generic.Dictionary<string, string>();
        orderitem["SubOrderNo"] = "Sub20170608002";    //设定二级商户名称
        orderitem["SubMerName"] = "测试二级商户1";    //设定二级商户名称
        orderitem["SubMerId"] = "103881104410001";    //设定二级商户代码
        orderitem["SubMerMCC"] = "0000";   //设定二级商户MCC码 
        orderitem["SubMerchantRemarks"] = "测试";   //二级商户备注项
