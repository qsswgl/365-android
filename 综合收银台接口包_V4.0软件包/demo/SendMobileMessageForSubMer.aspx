...
<script runat="server">
    ...
    protected void btnButton_Click(object sender, EventArgs e)
    {
        ...
        //1、生成担保确认查询请求对象
        com.abc.trustpay.client.ebus.SendMobileMessageForSubMer tRequest = new com.abc.trustpay.client.ebus.SendMobileMessageForSubMer();
        tRequest.dicRequest["SubMerId"] = txtSubMerchantNo.Text;//压缩标识 （必要信息）
        tRequest.dicRequest["SubMerchantAccNo"] = txtSubMerchantAccNo.Text;//压缩标识 （必要信息）
        //2、传送担保确认查询
...
<head>
    <title>农行网上支付平台-商户接口范例-二级商户短信验证码重发</title>
</head>
    ...
    <form id="form1" runat="server">
        ...
        <table>
            <tr>
                ...
                <td>
                    <asp:TextBox runat="server" ID='txtSubMerchantAccNo' Text='1234567890' />*必输</td>
            </tr>
            <tr>
                <td colspan="2">
