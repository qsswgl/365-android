...
<%
    ...
    eBusMerchantCommonRequest.dicRequest.put("TrxType", "CheckGuarantedFundAccDetail");
    ...
    eBusMerchantCommonRequest.dicRequest.put("NumSeqDtal", request.getParameter("NumSeqDtal"));
